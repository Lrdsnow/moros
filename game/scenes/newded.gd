...
func _ready():
		...
		if not save_game.file_exists("user://savegame.save"):
			$load.set_disabled(1)
		var _ded_pressed = $ded.connect("pressed", self, "_on_ded_pressed")
		var _set_pressed = $Continue.connect("pressed", self, "_on_set_pressed")
...
func _on_set_pressed():
	var setings = "res://scenes/new-lev1.tscn"
